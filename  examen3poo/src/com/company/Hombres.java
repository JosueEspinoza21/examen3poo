...
public class Hombres extends Calzado {
    private double costo;
    private String tipo;

    public Hombres(String tipo, double tamaño, String color, String marca, String codigo, int cantidad, double precio, double descuento) {
